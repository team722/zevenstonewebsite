      ...
      <div className="container mx-auto px-6 relative z-10">
         ...
         <div className="bg-zeven-blue rounded-[3rem] p-12 md:p-20 text-center text-white relative overflow-hidden">
            <div className="relative z-10 max-w-2xl mx-auto">
               ...
               <p className="text-blue-100 mb-8">Get the latest insights on strategy, design, and technology delivered to your inbox.</p>
               <div className="flex flex-col md:flex-row gap-4">
                  ...
                  <button className="px-8 py-4 bg-zeven-dark rounded-xl font-bold hover:bg-white hover:text-zeven-dark transition-colors shadow-xl">Subscribe</button>
               </div>
            </div>
            {/* Texture */}
