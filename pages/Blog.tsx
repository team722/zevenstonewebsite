            ...
            <div className="bg-zeven-blue rounded-[3rem] p-12 md:p-20 text-center text-white relative overflow-hidden">
               <div className="relative z-10 max-w-2xl mx-auto">
                  ...
                  <div className="flex flex-col md:flex-row gap-4">
                     <input type="email" placeholder="Enter your email" name="Email & Subscriptions" className="flex-grow px-6 py-4 rounded-xl text-zeven-dark border border-ring-white focus:outline-none" />
